...
#F-string output25
print(f"Your current savings is {format(savings, '.2f')}.")
print(f"At a {format(rate, '.0%')} interest rate, your savings account will be")
print(f"worth {format(future_value, '.2f')} in {format(years_to_double, '.1f')} years")
